              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-2/3 p-6 flex flex-col justify-center">
                  <div className="flex flex-col items-center md:items-start text-center md:text-left mb-4">
                    ...
                    <h3 className="text-xl font-bold text-ge-blue">人材紹介サービス</h3>
                  </div>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-2/3 p-6 flex flex-col justify-center">
                  <div className="flex flex-col items-center md:items-start text-center md:text-left mb-4">
                    ...
                    <h3 className="text-xl font-bold text-ge-blue">ホテル清掃サービス</h3>
                  </div>
                  <p className="text-ge-dark">お客様に快適な空間をご提供するため、丁寧かつ迅速な清掃を心がけております。経験豊富なスタッフが、安心・安全な環境づくりをサポートいたします。清潔で心地よいホテルライフをお届けします。</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-2/3 p-6 flex flex-col justify-center">
                  <div className="flex flex-col items-center md:items-start text-center md:text-left mb-4">
                    ...
                    <h3 className="text-xl font-bold text-ge-blue">留学支援業務</h3>
                  </div>
                  <p className="text-ge-dark">GLOBAL EYEでは、留学生・外国人学生の面接や日本語テストの実施だけでなく、日本語学校へのご紹介から入学までのフォローアップも行っております。学生一人ひとりの状況や目標に寄り添い、きめ細やかなサポートを提供することで、安心して日本での学びをスタートできるよう全力でお手伝いいたします。</p>
                </div>
              </div>
            </div>
          </div>
